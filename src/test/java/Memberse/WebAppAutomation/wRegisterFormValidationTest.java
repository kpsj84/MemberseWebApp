...
public class wRegisterFormValidationTest extends WBase {
	...
	public void wRegisterFormValidationTestCase() throws InterruptedException {
		...
		String msg3 = driver.findElement(By.xpath("//*[@id=\"__next\"]/div[2]/div/div[3]/main/div/div/div/div/div/div/div/ul/li[3]/span[2]")).getText(); 
		Assert.assertEquals(msg3, "Confirm Password is a required field.");
		System.out.println(msg3);
		
		sp.Email().sendKeys("abc@abc");
		Thread.sleep(2000);
		String msg4 = driver.findElement(By.xpath("//*[@id=\"__next\"]/div[2]/div/div[3]/main/div/div/div/div/div/div/div/ul/li[1]/span[2]")).getText(); 
		...
		Thread.sleep(4000);
		String msg5 = driver.findElement(By.xpath("//*[@id=\"__next\"]/div[2]/div/div[3]/main/div/div/div/div/div/div/div/ul/li[2]/span[2]")).getText(); 
