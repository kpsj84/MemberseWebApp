...
public class wCreateAudioPostTest extends WBase{
	...
	public void wCreatAudioPostTestCase()throws InterruptedException, AWTException{
    	...
    	String autotext=getSaltString();
  		...
  		ewait.until(ExpectedConditions.elementToBeClickable(cpp.titleBox())).sendKeys("Auto Generated Audio Post - " +autotext);
  		...
  		ewait.until(ExpectedConditions.elementToBeClickable(cpp.audioButton())).click();
  		ewait.until(ExpectedConditions.elementToBeClickable(cpp.uploadAudio())).click();
        ...
        */
        ...
        u.shortDelay();
	    WebElement Text1 = driver.findElement(By.xpath("//p[contains(text(), 'Auto Generated Audio Post - " +autotext+ "')]"));
